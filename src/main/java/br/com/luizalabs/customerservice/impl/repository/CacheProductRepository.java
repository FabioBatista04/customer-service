...
public class CacheProductRepository {
    ...
    private final ReactiveRedisOperations<String, ProductImplModel> productRedisTemplate;

    public CacheProductRepository(ReactiveRedisOperations<String, ProductImplModel> template) {
